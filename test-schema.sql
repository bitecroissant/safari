...
CREATE TABLE IF NOT EXISTS PoetryLines (id INTEGER PRIMARY KEY, gmtCreate TEXT, gmtModified TEXT, isDeleted INTEGER, line TEXT, author TEXT, dynasty TEXT, title TEXT, showDate TEXT);
